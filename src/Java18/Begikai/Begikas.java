...
public class Begikas implements Comparable<Begikas>{
    ...
    private Integer punktuKiekis;

    public Begikas(Integer begikoNr, String vardas,
                   String pavarde, String pradziosLaikas, String pabaigosLaikas, Integer punktuKiekis) {
        ...
        this.punktuKiekis = punktuKiekis;
    }

    public String toString() {
        return vardas + " "
                + pavarde + " " + punktai.size() + " " + gautiBegimoLaika();
           }
    ...
    public Integer getPunktuKiekis() {
        return punktuKiekis;
    }

    public void setPunktuKiekis(Integer punktuKiekis) {
        this.punktuKiekis = punktuKiekis;
    }
